                    ...
                    <div class="card-body">
                        ...
                        <form id="post_create" name="post_create"  enctype="multipart/form-data">
                            ...
                            <div class="form-group row text-center">
                                <div class="preview-images-zone" id="preview-images-zone">
                                ...
                                <input type="file" id="pro-image" onclick="$('#pro-image').click()" name="pro-image[]" class="text-center center-block well well-sm" multiple>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <input list="categorylist" id="selectcategory" name="selectcategory" required class="chosen md-3 form-control" placeholder="Select Category"  onchange="CategoryPickup()" style="display: none; margin-top: 10px">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <div class="range range-primary">
                                        <input type="range" name="quality" min="1" max="10" value="5" onchange="quality.value=value">
