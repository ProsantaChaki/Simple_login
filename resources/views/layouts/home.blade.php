...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/') }}/assets/css/cs-skin-elastic.css">F
    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="menu-title">Manu</li><!-- /.menu-title -->
                ...
                <li class="menu-item-has-children active dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fas fa-donate"></i>Donation</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-dashboard"></i><a href="#">All</a></li>
                        <li><i class="fas fa-edit"></i><a href="#">Create</a></li>
                        <li><i class="fas fa-edit"></i><a href="#">Update</a></li>
                        <li><i class="fab fa-expeditedssl"></i><a href="#">Delete</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fas fa-hands-helping"></i>Ask for Help</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-dashboard"></i><a href="#">All</a></li>
                        <li><i class="fas fa-edit"></i><a href="#">Create</a></li>
                        <li><i class="fas fa-edit"></i><a href="#">Update</a></li>
